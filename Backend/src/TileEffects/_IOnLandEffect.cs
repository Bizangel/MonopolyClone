...
[JsonConverter(
  ...
  new TileEffectID[] { TileEffectID.Property, TileEffectID.RawSumEffect }, // specify keys
  new Type[] { typeof(PropertyEffect), typeof(RawSumEffect) } // specify keys mapping to json types
  )
]
